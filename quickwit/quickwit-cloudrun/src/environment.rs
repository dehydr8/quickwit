...
pub static ENABLE_VERBOSE_JSON_LOGS: Lazy<bool> =
    Lazy::new(|| get_bool_from_env("QW_CLOUDRUN_ENABLE_VERBOSE_JSON_LOGS", false));

pub static OPENTELEMETRY_URL: Lazy<Option<String>> =
    Lazy::new(|| var("QW_CLOUDRUN_OPENTELEMETRY_URL").ok());

pub static OPENTELEMETRY_AUTHORIZATION: Lazy<Option<String>> =
    Lazy::new(|| var("QW_CLOUDRUN_OPENTELEMETRY_AUTHORIZATION").ok());
