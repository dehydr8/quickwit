...
version: 0.8
node_id: cloudrun-searcher
metastore_uri: gs://${QW_CLOUDRUN_METASTORE_BUCKET}/${QW_CLOUDRUN_METASTORE_PREFIX:-index}#polling_interval=${QW_CLOUDRUN_SEARCHER_METASTORE_POLLING_INTERVAL_SECONDS:-60}s
default_index_root_uri: gs://${QW_CLOUDRUN_INDEX_BUCKET}/${QW_CLOUDRUN_INDEX_PREFIX:-index}
data_dir: /tmp
searcher:
  partial_request_cache_capacity: ${QW_CLOUDRUN_PARTIAL_REQUEST_CACHE_CAPACITY:-64M}
"#;
...
mod tests {
    ...
    async fn test_load_config() {
        ...
        assert_eq!(
            ...
            "gs://mock-test-bucket/index#polling_interval=60s"
        );
        assert_eq!(
